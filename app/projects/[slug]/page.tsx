    ...
    "discord-ai": {
      ...
      images: [
        ...
        { 
          ...
          description: "I asked ServerMate to compare the countryside of Georgia (the country) with Abu Dhabi. The bot wrote a structured multi-paragraph comparison covering topography, climate, color palettes, and atmosphere for both regions. It included four images pulled from Google - two showing Georgia's green mountains, stone houses, and fertile landscapes, and two showing Abu Dhabi's golden desert dunes with off-road vehicles. The comparison was accurate and written in a travel-guide style, covering things like Georgia being mountainous and temperate while Abu Dhabi is hot and arid. This demonstrates the bot's ability to retrieve or pull multiple relevant images from the web, write structured explanations, make accurate comparisons, produce professional content, and combine visual and textual elements in one cohesive response."
        },
        { 
